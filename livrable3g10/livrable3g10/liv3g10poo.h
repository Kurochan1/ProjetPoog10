...
#include "Gestion de commandes.h" 
#include "Gestion de stock.h" 
#include "Gestion des statistiques.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &liv3g10poo::button2_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &liv3g10poo::button4_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &liv3g10poo::button5_Click);
			// 
			// label2
			// 
			...
			this->ClientSize = System::Drawing::Size(966, 540);
...
#pragma endregion
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		Gestiondesclients^ GDP = gcnew Gestiondesclients();
		GDP->ShowDialog();
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	Gestiondecommandes^ GDP = gcnew Gestiondecommandes(); 
	GDP->ShowDialog(); 

}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	
	Gestiondesstatistiques^ GDP = gcnew Gestiondesstatistiques(); 
	GDP->ShowDialog();
}
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	
	Gestiondestock^ GDP = gcnew Gestiondestock(); 
	GDP->ShowDialog();
}
};
}
